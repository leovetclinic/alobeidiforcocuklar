...
export default function Storefront() {
  ...
  if (loading) return <div dir="rtl" className="fixed inset-0 z-[200] grid place-items-center overflow-hidden bg-[#fff9f6] px-6 text-center text-[#65585b]"><div className="mx-auto w-full max-w-sm"><img src="/favicon.jpg" className="mx-auto size-28 rounded-full border-4 border-white object-cover shadow-lg sm:size-32" alt="شعار العبيدي لأناقة طفلك"/><b className="mt-5 block text-xl tracking-[.18em] sm:text-2xl">ALOBEIDI</b><div className="my-4 flex justify-center gap-3"><i className="size-3 animate-bounce rounded-full bg-[#c9d9bd]"/><i className="size-3 animate-bounce rounded-full bg-[#b7dbea] [animation-delay:150ms]"/><i className="size-3 animate-bounce rounded-full bg-[#e8b7c5] [animation-delay:300ms]"/></div><p className="mx-auto max-w-xs text-base font-bold leading-8 sm:text-lg">نجهز لك المتجر بلمسة ناعمة وسريعة.. يرجى الانتظار لطفاً</p></div></div>;
  return (
    <div
      dir="rtl"
